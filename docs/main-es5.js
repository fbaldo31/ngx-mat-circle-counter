...
var NgxMatCircleCounterComponent = /** @class */ (function () {
    function NgxMatCircleCounterComponent(hostElement) {
        var _this = this;
        ...
        this.onWindowChange = function () {
            if (_this.mode !== 'viewport') {
                return;
            }
            if (!_this.animationHasRun && _this.isElementInViewport()) {
                _this.startAnimation();
            }
        };
    }
    NgxMatCircleCounterComponent.prototype.ngOnInit = function () {
    ...
    NgxMatCircleCounterComponent.prototype.startAnimation = function () {
        var _this = this;
        this.animationHasRun = true;
        // Start
        var interval = setInterval(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    ...
    NgxMatCircleCounterComponent.prototype.listenEvents = function () {
    ...
    NgxMatCircleCounterComponent.prototype.isElementInViewport = function () {
        // console.log('viewport', this.size);
        var rect = this.hostElement.nativeElement.getBoundingClientRect();
        // tslint:disable-next-line
        return rect.top >= 0 && rect.bottom <= (window.innerHeight || document.documentElement.clientHeight);
    };
    NgxMatCircleCounterComponent.ctorParameters = function () { return [
    ...
    return NgxMatCircleCounterComponent;
}());
...
var NgxMatCircleCounterModule = /** @class */ (function () {
    function NgxMatCircleCounterModule() {
    }
    ...
    return NgxMatCircleCounterModule;
}());
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.applyChanges = function () {
        ...
        setTimeout(function () { return _this.isVisible = true; }, 1);
    };
